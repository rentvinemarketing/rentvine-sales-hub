...
const caseStudies = [
  {
    customer: "Rosenbaum Realty Group", role: "Tiffany Rosenbaum, Founder & CEO",
    switched: "appfolio", switchedLabel: "Switched, scaled 122%, and acquired in one year",
    units: "large", unitsLabel: "1,260+ units (mixed portfolio)",
    location: "west", locationLabel: "Gilbert, AZ (Phoenix metro)",
    quote: "Fear is a liar. You're worried about something that hasn't even happened, and nine times out of ten it doesn't happen.",
    outreachHook: "Tiffany Rosenbaum spent two years vetting software before switching to Rentvine, then grew 122% in a year, from 500 to 1,260 units, and closed a 300-unit acquisition mid-migration on the same go-live date as her existing portfolio. Two simultaneous migrations, zero margin for error. Great share for a prospect worried that switching software during a growth spurt is too risky.",
    keyOutcomes: ["Grew from 500 to 1,260 units (122%) in the same year as the software switch.","Ran two simultaneous portfolio migrations on one go-live date after a surprise 300-unit acquisition.","Rentvine handled team training directly, freeing up the CEO's bandwidth during hypergrowth.","Open API let the team keep the integrations they'd already built instead of starting over."],
  ...
  {
    customer: "Prandi Property Management", role: "Melissa Prandi, Founder & Broker of Record",
    switched: "propertyware", switchedLabel: "Passed a CA DRE audit with zero violations",
    units: "mid", unitsLabel: "650+ properties",
    location: "west", locationLabel: "Marin County, CA",
    quote: "When that letter came, it was Merry Christmas.",
    outreachHook: "Three months after switching banks, software, and their director of accounting, Prandi Property Management got hit with a California DRE audit, one of the strictest compliance reviews in the industry. The result: zero violations, a result so rare the state didn't have a form for it. Worth sharing with any prospect nervous about compliance risk during a migration.",
    keyOutcomes: ["Passed a California DRE audit with zero violations, roughly 1% of audits come back clean.","Produced every report the auditor requested on demand, even mid-migration.","Rentvine support responded immediately whenever a report needed reformatting for the auditor.","Passed the audit despite three simultaneous variables: new bank, new software, new accounting director."],
...
*/
const reviews = [
  { name: "Craig Caffarello", company: "Your Place Property Management", territory: "IL", source: "g2", stars: 5, date: "2026-07-05", text: "Easy to Use, Open API, and Rapid Improvements with Rentvine", body: "The use of AI integration is really fun to watch and Rentvine is making daily improvements to the software.", tags: ["easy-to-use", "integrations", "ai"], hsId: null },
  { name: "DWC Property", company: null, territory: null, source: "google", stars: 5, date: "2026-06-29", text: "Has been a godsend for our property management company.", body: null, tags: [], hsId: null },
  { name: "Sal B", company: null, territory: null, source: "g2", stars: 5, date: "2026-06-27", text: "Open API and Custom Dashboards That Make Reporting Shine", body: "I  like their Open API, especially now with AI. Being able to build our own dashboards and reporting makes a big difference, and having an API available to us is great.", tags: ["integrations", "ai"], hsId: null },
  { name: "Amy B", company: null, territory: null, source: "google", stars: 5, date: "2026-06-26", text: "We have utilized Rentvine for coming up to 5 years now and absolutely love it - it is very intuitive, and makes my every day life easier. Their team are all passionate and it shows!\n\nI recently had the pleasure of enjoying a great meeting with Keisha & Brian on their new insurance offerings, and the H04 policy that they are implementing looks really wonderful - it will help remove a huge time burden of chasing up expired policies.  Excited to check this out!", body: null, tags: ["support", "easy-to-use"], hsId: null },
  { name: "Cynthia L", company: null, territory: null, source: "g2", stars: 5, date: "2026-06-26", text: "Streamlined Property Management with Robust Features", body: "I really appreciate that Rentvine was clearly built with the property manager's day-to-day operations in mind. The system effectively brings together accounting, leasing, maintenance, communications, and workflows all in one system.", tags: ["easy-to-use", "accounting", "maintenance"], hsId: null },
  ...
  { name: "Anonymous", company: "Unknown", territory: "Unknown", source: "g2", stars: 5, date: "2026-06-17", text: "Easy Setup with Excellent Support", body: "I really like Rentvine's ease of use. The support team is great, the initial setup was very easy, and it keeps us organized with capital management, billing, and maintenance.", tags: ["support", "easy-to-use", "maintenance"], hsId: null },
  ...
  { name: "Anonymous", company: "Unknown", territory: "Unknown", source: "g2", stars: 4, date: "2026-06-09", text: "Highly Customizable, Quick Support for Property Management", body: "I like that Rentvine is very customizable and adaptable to the specific needs of a property management company. I get a response within thirty minutes to an hour whenever I submit a ticket.", tags: ["support"], hsId: null },
  ...
  { name: "Anonymous", company: "Unknown", territory: "Unknown", source: "g2", stars: 4, date: "2026-04-17", text: "Friendly UI That Makes Finding What You Need Easy", body: "Friendly UI that makes finding what you need easy", tags: [], hsId: null },
  ...
  { name: "Alan C.", company: "Unknown", territory: "Unknown", source: "g2", stars: 4, date: "2026-04-08", text: "Rentvine Streamlines Property Management with a Clean, Organized Portal", body: "The portal experience for both owners and tenants is clean — communication, statements, and workflows all in one place.", tags: ["easy-to-use", "accounting"], hsId: null },
  { name: "Sandra P.", company: "Cactus Property Management", territory: "AZ", source: "g2", stars: 4, date: "2026-04-08", text: "Helpful Rentvine Team, But Support Response Times Can Lag", body: "Helpful Rentvine team and great support throughout", tags: ["support"], hsId: null },
  { name: "Sue G.", company: "PMI GA", territory: "GA", source: "g2", stars: 4, date: "2026-04-02", text: "Efficient Accounting Tool with Great Support", body: "The support feature with videos and step-by-step directions is very helpful — I can rely on Rentvine every time.", tags: ["support", "accounting"], hsId: null },
...
/* =====================================================================
   COMPETITOR ANALYSIS
   Pros/cons per competitor, used by competitors.html ("competitor analysis"
   in nav). Source: rentvinemarketing/competitorhub, pulled 2026-07-14.
   This is a one-time copy, not a live sync. Amy's team updates
   competitor-hub monthly, so this array needs a manual refresh on the
   same cadence (or whenever she flags a change) until/unless we build
   a proper sync.

   `id` here is the join key competitorNews entries use (below) to link
   a news item back to the matching battlecard.
   ===================================================================== */
...
/* =====================================================================
   COMPETITOR NEWS
   Feed for competitor-news.html. Auto-written weekly (Mondays 12:06pm,
   same run as the review refresh) from Slack #growth-marketing-channel.
   This is the automated counterpart to competitorAnalysis above: news
   items are timestamped and disposable, the analysis array is a
   hand-maintained battlecard. Keeping them separate arrays means the
   automation can only ever touch this one, never the manually curated
   analysis content, same boundary rule the review refresh already
   follows with the reviews array.

   Each item:
     competitorId: matches an `id` in competitorAnalysis above, used to
                   cross-link a news item to its battlecard.
     competitor:   display name (denormalized, so pages don't need to
                   look up competitorAnalysis just to render a label).
     title:        short headline, sentence case.
     date:         YYYY-MM-DD.
     source:       where the update came from (usually the Slack channel).
     summary:      1-2 sentences, brand-strict voice, no em dashes.
     url:          optional external link if the Slack message had one.
     tags:         optional, for future search integration.
